                    ...
                    <Col xs={12} lg={6} marginTop='-30px' className={styles.box1Right}>
                        ...
                        <Col className={styles.box1Item1Buttons} width="fit-content">
                            ...
                            <Button variant="outlined" className={styles.button2}>
                                <Typography  fontSize="1.2rem" color="#122d40" className={styles.button1Text}>مشاهده محصولات</Typography>
                            </Button>
                        </Col>
                    </Col>
                    ...
                    <Row spacing={4} className={styles.someOffer}>
                        <Col xs={12} lg={6} height="50%">
                            <div className={styles.box2Column1Item1}>
                                <Typography  fontSize='1.3rem' color='white' display="block" textAlign='left' margin='0 0 0 15px' paddingTop="15px">
                                    تخفیف ۵۰٪
                                </Typography>
                                <Typography  fontSize='2rem' color='white' display="block" textAlign='left' margin='0 0 0 15px' paddingTop="15px">
                                    سس ها
                                </Typography>
                            </div>
                        </Col>
                        <Col xs={12} lg={6} height="50%">
                            <div className={styles.box2Column1Item2}>
                                <Typography  fontSize='1.3rem' color='#01e281' display="block" textAlign='right' margin='0 15px 0 0' paddingTop="15px">
                                    تخفیف ۵۰٪
                                </Typography>
                                <Typography  fontSize='2rem' color='#122d40' display="block" textAlign='right' margin='0 15px 0 0' paddingTop="15px">
                                    تنقلات
                                </Typography>
                            </div>
                        </Col>
                        <Col xs={12} height="50%">
                            <div className={styles.box2Column1Item3}>
                                <Typography  fontSize='1.3rem' color='#01e281' display="block" textAlign='left' margin='0 0 0 15px' paddingTop="15px">
                                    تخفیف ویژه ۵۰٪
                                </Typography>
                                <Typography  fontSize='2rem' color='white' display="block" textAlign='left' margin='0 0 0 15px' paddingTop="15px">
                                    روی تمامی میوه ها
                ...
                <Col xs={12} lg={4}>
                    <div className={styles.box2Column2}>
                        ...
                        <Button variant="contained" color="primary" className={styles.button3}>
                            <Typography  className={styles.button3Text} fontSize="1rem">الان
                                بخرید</Typography>
                        </Button>
                    </div>
                </Col>
            ...
            <Row className={styles.box5}>
                    <Col xs={12} md={6} className={styles.box5Col1}>
                        <div className={styles.box5Text}>
                            <Typography variant="h1" fontSize='2rem' color='white' display="block" textAlign='center'
                                        margin="40px 0 0 0" opacity='95%' className={styles.box5TextH1}>
                                سوپر مارکت اکسترا
                            </Typography>
                            <Typography  fontSize='3rem' color='white' display="block" textAlign='center'
                                        margin='20px 0 30px 0' paddingTop="15px" opacity='95%'>
                                سفارش با موبایل
                            </Typography>
